...
class ScheduleController extends Controller
{
    ...
    public function getMM() {
        $list = DB::table('schedules as s')
            ...
            ->select('s.id as chat_id', 'e.id as engineer_id', 'a.id as area_id', 's.date', 'e.name as engineer', 'e.email as engineer_email', 'e.available', 's.date', 's.start', 's.end', 'a.name as area', 'a.component')
